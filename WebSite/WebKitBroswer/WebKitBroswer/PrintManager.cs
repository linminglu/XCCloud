...
namespace WebKitBrowser
{
    internal class PrintManager
    {
        ...
        private WebKitBrowserUC _owner;
        ...
        public PrintManager(PrintDocument Document, WebKitBrowserUC Owner)
        {
        ...
        private void _document_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            _owner.Invoke(new MethodInvoker(delegate() {
                _webFramePrivate.spoolPages(_hDC, _page, _page, ptr);
            }));
