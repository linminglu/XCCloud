...
namespace XCCloudWebBar.Pay.Alipay
{
    public class AliPayConfig
    {
        ...
        {
            get { return ConfigurationManager.AppSettings["AlipayNotifyUrl"]; }
        }
        ...
        /// </summary>
        public static string MiniAppTemplateId
        {
            get
            {
                return "NmFkODNlNGQwNzlhNzVhMTBkYzY1ODJkZTI0YmRkMzA=";
            }
        }
        ...
        /// 莘拍档支付宝小程序支付回调
        /// </summary>
        public static string AliMiniAppNotify_url
        {
            get
            {
                return ConfigurationManager.AppSettings["XcGameManageAliMiniAppNotifyUrl"];
            }
        }
        ...
        /// 莘拍档H5支付宝支付回调
        /// </summary>
        public static string AliH5NotifyUrl
        {
            get
            {
                return ConfigurationManager.AppSettings["XcGameManageAliH5NotifyUrl"];
            }
        }
        ...
        /// 支付宝授权后跳转到的前端地址
        /// </summary>
        public static string AliAuthRedirectUrl
        {
            get
            {
                return ConfigurationManager.AppSettings["AliAuthRedirectUrl"];
            }
        }

        /// <summary>
        /// 支付宝商户用公钥（应用：莘宸娃娃机乐园，用于莘拍档H5）
        /// </summary>
        public static string alipay_auth_public_key
        {
            get
            {
                return "";
            }
        }
        
        /// <summary>
        /// 支付宝商户私钥（应用：莘宸娃娃机乐园，用于莘拍档H5）
        /// </summary>
        public static string merchant_auth_private_key
        {
            get
            {
                return "";
            }
        }
        
        /// <summary>
        /// APPID（应用：莘宸娃娃机乐园，用于莘拍档H5）
        /// </summary>
        public static string authAppId
        {
            get
            {
                return "2018032302435860";
            }
        }
    }
