...
using XCCloudWebBar.WeiXin.Config;
    ...
    public class MessageMana
    {
        public static bool PushMessage(WeiXinMesageType messageType,string openId,object dataModel,out string errMsg)
        {
            ...
            switch (messageType)
            {
                ...
                case WeiXinMesageType.PhoneVerifyCode: return Push<PhoneVerifyCodeConfigModel, PhoneVerifyCodeModel>(openId, (PhoneVerifyCodeModel)dataModel, out errMsg);
