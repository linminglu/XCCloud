    ...
    public class Member : ApiBase
    {
        ...
        public object cardUnLock(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                if (schedule == null)
                {
                    return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "当前班次为空，不能进行解锁操作");
                }

                string modifyField = "手动解锁：";
                switch(lockType)
                {
                    case 0: modifyField += "机台退分限额锁定"; break;
                    case 1: modifyField += "机台非法操作锁定"; break;
                    case 2: modifyField += "人工锁定"; break;
                    case 3: modifyField += "游乐项目入场锁定"; break;
                }

                string oldcontext = card.IsLock.ToString();
                ...
                if (strLockBinary[lockType] == '1')
                {
                    using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                    {
                        ...
                        mic.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        mic.MerchID = merchID;
                        mic.StoreID = storeId;
                        mic.MemberID = card.MemberID;
                        mic.CardID = card.ID;
                        mic.ModifyFied = modifyField;
                        mic.OldContext = oldcontext;
                        mic.NewContext = lockState.ToString();
        ...
        public object cardLevelChange(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    ...
                    mic.MemberID = card.MemberID;
                    mic.CardID = card.ID;
                    mic.ModifyFied = "会员卡等级变更";
                    mic.OldContext = XCCloudStoreBusiness.GetMemberLevel(card.MemberLevelID.Value).MemberLevelName;
                    mic.NewContext = XCCloudStoreBusiness.GetMemberLevel(level.ID).MemberLevelName;
                    mic.ModifyTime = DateTime.Now;
                    mic.WorkStation = workStation;
                    mic.UserID = userId;
                    mic.CheckDate = schedule.CheckDate;
        ...
        public object cardManualLock(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                if (schedule == null)
                {
                    return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "当前班次为空，不能进行锁定操作");
                }
        ...
        public object memberCardModify(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                Flw_MemberInfo_Change mic = null;
                DateTime now = DateTime.Now;
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    if (mi.UserName.Trim() != userName.Trim())
                    {
                        mic = new Flw_MemberInfo_Change();
                        mic.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        mic.MerchID = merchID;
                        mic.StoreID = storeId;
                        mic.MemberID = card.MemberID;
                        mic.CardID = card.ID;
                        mic.ModifyFied = "昵称";
                        mic.OldContext = mi.UserName;
                        mic.NewContext = userName;
                        mic.ModifyTime = now;
                        mic.WorkStation = workStation;
                        mic.UserID = userId;
                        mic.CheckDate = schedule.CheckDate;
                    ...
                    if (mi.Gender != gender.Toint(0))
                    {
                        ...
                        mic.CardID = card.ID;
                        mic.ModifyFied = "性别";
                        mic.OldContext = mi.Gender.ToString();
                        mic.NewContext = gender;
                        mic.ModifyTime = now;
                        mic.WorkStation = workStation;
                        mic.UserID = userId;
                        mic.CheckDate = schedule.CheckDate;
                    ...
                    if (right.AllowPush != allowIn.Toint(0))
                    {
                        mic = new Flw_MemberInfo_Change();
                        mic.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        mic.MerchID = merchID;
                        ...
                        mic.CardID = card.ID;
                        mic.ModifyFied = "允许上分";
                        mic.OldContext = right.AllowPush.ToString();
                        mic.NewContext = allowIn;
                        mic.ModifyTime = now;
                        mic.WorkStation = workStation;
                        mic.UserID = userId;
                        mic.CheckDate = schedule.CheckDate;
                    ...
                    if (right.AllowOut != allowOut.Toint(0))
                    {
                        mic = new Flw_MemberInfo_Change();
                        mic.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        mic.MerchID = merchID;
                        ...
                        mic.CardID = card.ID;
                        mic.ModifyFied = "允许退分";
                        mic.OldContext = right.AllowOut.ToString();
                        mic.NewContext = allowOut;
                        mic.ModifyTime = now;
                        mic.WorkStation = workStation;
                        mic.UserID = userId;
                        mic.CheckDate = schedule.CheckDate;
                    ...
                    if (right.AllowExitCoin != allowExitCoin.Toint(0))
                    {
                        mic = new Flw_MemberInfo_Change();
                        mic.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        mic.MerchID = merchID;
                        ...
                        mic.CardID = card.ID;
                        mic.ModifyFied = "允许兑币";
                        mic.OldContext = right.AllowExitCoin.ToString();
                        mic.NewContext = allowExitCoin;
                        mic.ModifyTime = now;
                        mic.WorkStation = workStation;
                        mic.UserID = userId;
                        mic.CheckDate = schedule.CheckDate;
                    ...
                    if (right.AllowSaleCoin != allowSaleCoin.Toint(0))
                    {
                        mic = new Flw_MemberInfo_Change();
                        mic.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        mic.MerchID = merchID;
                        ...
                        mic.CardID = card.ID;
                        mic.ModifyFied = "允许售币";
                        mic.OldContext = right.AllowSaleCoin.ToString();
                        mic.NewContext = allowSaleCoin;
                        mic.ModifyTime = now;
                        mic.WorkStation = workStation;
                        mic.UserID = userId;
                        mic.CheckDate = schedule.CheckDate;
                    ...
                    if (right.AllowSaveCoin != allowSaveCoin.Toint(0))
                    {
                        mic = new Flw_MemberInfo_Change();
                        mic.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        mic.MerchID = merchID;
                        ...
                        mic.CardID = card.ID;
                        mic.ModifyFied = "允许存币";
                        mic.OldContext = right.AllowSaveCoin.ToString();
                        mic.NewContext = allowSaveCoin;
                        mic.ModifyTime = now;
                        mic.WorkStation = workStation;
                        mic.UserID = userId;
                        mic.CheckDate = schedule.CheckDate;
                    ...
                    if (right.AllowFreeCoin != allowFreeCoin.Toint(0))
                    {
                        mic = new Flw_MemberInfo_Change();
                        mic.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        mic.MerchID = merchID;
                        ...
                        mic.CardID = card.ID;
                        mic.ModifyFied = "允许送币";
                        mic.OldContext = right.AllowFreeCoin.ToString();
                        mic.NewContext = allowFreeCoin;
                        mic.ModifyTime = now;
                        mic.WorkStation = workStation;
                        mic.UserID = userId;
                        mic.CheckDate = schedule.CheckDate;
                    ...
                    if (right.AllowRenew != allowRenew.Toint(0))
                    {
                        mic = new Flw_MemberInfo_Change();
                        mic.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        mic.MerchID = merchID;
                        ...
                        mic.CardID = card.ID;
                        mic.ModifyFied = "允许续卡";
                        mic.OldContext = right.AllowRenew.ToString();
                        mic.NewContext = allowRenew;
                        mic.ModifyTime = now;
                        mic.WorkStation = workStation;
                        mic.UserID = userId;
                        mic.CheckDate = schedule.CheckDate;
        ...
        public object ConfirmBackCard(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    ...
                    {
                        //目标储值金类别ID
                        int targetId = memberBalanceExchange.Where(t=> t.TargetBalanceIndex > 0).Select(t => new { t.TargetBalanceIndex }).FirstOrDefault().TargetBalanceIndex;
                        //目标余额ID
                        var queryTargetBalanceId = from a in Data_Card_BalanceService.N.GetModels(t => t.BalanceIndex == targetId && t.CardIndex == memberCard.ID)
                        ...
                        //目标余额【赠送区】余额 (储值金赠送余额)
                        var queryTargetBalanceFree = from a in Data_Card_Balance_FreeService.N.GetModels(t => t.BalanceIndex == targetId && t.CardIndex == memberCard.ID)
                                                     join b in Data_Card_Balance_StoreListService.N.GetModels(t => t.StoreID == storeId) on a.ID equals b.CardBalanceID 
                                                     select new
                                                     {
                                                         Balance = a.Balance
                        ...
                        {                            
                            ...
                            if (exchange.BalanceIndex != exchange.TargetBalanceIndex)
                            {
                                ...
                                fmd2.FreeBalance = targetBalanceFree == null ? 0 : targetBalanceFree.Balance.Todecimal(0);
                        ...
                        //3、储值金退款 减少
                        Flw_MemberData fmd3 = new Flw_MemberData();
                        fmd3.ID = RedisCacheHelper.CreateStoreSerialNo(storeId);
                        fmd3.MerchID = merchID;
                        fmd3.StoreID = storeId;
                        fmd3.MemberID = member.ID;
                        ...
                        fmd3.BalanceTotal = fmd3.Balance + fmd3.FreeBalance;
                        fmd3.Note = "退储值金";
                        fmd3.UserID = userId;
                        fmd3.DeviceID = 0;
                        fmd3.ScheduleID = schedule.ID;
                        fmd3.AuthorID = 0;
                        ...
                        memberParentCardExit.CardID = memberCard.ID;
                    ...
                    if (backType == "2" && storeExitCardConfig != null && storeExitCardConfig.ParameterValue == "1")
                    {
                        ...
                        {
                            //余额ID
                            var queryCardBalanceId = from a in Data_Card_BalanceService.N.GetModels(t => t.BalanceIndex == item.BalanceIndex && t.CardIndex == memberCard.ID)
                                                       join b in Data_Card_Balance_StoreListService.N.GetModels(t => t.StoreID == storeId) on a.ID equals b.CardBalanceID
                                                       select new
                                                       {
                                                           BalanceId = a.ID
                            ...
                            {
                                Data_Card_Balance cardBalance = Data_Card_BalanceService.I.GetModels(b => b.ID == cardBalanceId.BalanceId).FirstOrDefault();
                            ...
                            //赠送余额ID
                            var queryCardFreeBalanceId = from a in Data_Card_Balance_FreeService.N.GetModels(t => t.BalanceIndex == item.BalanceIndex && t.CardIndex == memberCard.ID)
                                                     join b in Data_Card_Balance_StoreListService.N.GetModels(t => t.StoreID == storeId) on a.ID equals b.CardBalanceID
                                                     select new
                                                     {
                                                         BalanceId = a.ID
                                                     };
                            var cardFreeBalanceId = queryCardFreeBalanceId.FirstOrDefault();
                            if (cardBalanceId != null)
                            {
                                Data_Card_Balance cardBalance = Data_Card_BalanceService.I.GetModels(b => b.ID == cardFreeBalanceId.BalanceId).FirstOrDefault();
                                if (cardBalance.Balance > 0)
                                {
                                    cardBalance.Balance = 0;
                                    cardBalance.UpdateTime = DateTime.Now;
        ...
        public object createOperateCardOrder(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                switch(operateType)
                {
                    case "0": OpFree = memberLevel.ChangeFee.HasValue ? memberLevel.ChangeFee.Value : 0; singleType = 5; break;
                    case "1": OpFree = memberLevel.RechargeFee.HasValue ? memberLevel.RechargeFee.Value : 0; singleType = 4; break;
                    case "2": OpFree = memberLevel.ContinueFee.HasValue ? memberLevel.ContinueFee.Value : 0; singleType = 3; break;
                }
                ...
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    ...
                    cardChange.OldCardID = oldCard.ID;
                    cardChange.NewCardID = "";
                    ...
                    foodSale.ID = saleId;
                    foodSale.MerchID = merchID;
                    foodSale.StoreID = storeId;
                    foodSale.FlowType = 0;
                    foodSale.SingleType = singleType;
                    foodSale.FoodID = cardChange.ID;
                    foodSale.SaleCount = 1;
                    foodSale.Point = 0;
                    foodSale.PointBalance = 0;
                    foodSale.MemberLevelID = oldCard.MemberLevelID;
                    foodSale.Deposit = 0;
                    foodSale.OpenFee = 0;
                    foodSale.RenewFee = memberLevel.ContinueFee.HasValue ? memberLevel.ContinueFee.Value : 0;
                    foodSale.ChangeFee = memberLevel.ChangeFee.HasValue ? memberLevel.ChangeFee.Value : 0;
                    foodSale.ReissueFee = memberLevel.RechargeFee.HasValue ? memberLevel.RechargeFee.Value : 0;
                    foodSale.TotalMoney = OpFree;
                    foodSale.Note = operate;
                    foodSale.TaxFee = 0;
                    foodSale.TaxTotal = 0;
                    ...
                    saleDetail.ID = RedisCacheHelper.CreateCloudSerialNo(storeId);
                    saleDetail.MerchID = merchID;
        ...
        public object rechangeCard(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                if (sale == null)
                {
                    return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "订单销售记录不存在");
                }
                ...
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    ...
                    Flw_MemberCard_Change cardChange = Flw_MemberCard_ChangeService.I.GetModels(t => t.ID == sale.FoodID).FirstOrDefault();
                    cardChange.NewCardID = newCard.ID;
                    cardChange.State = 1;
                    cardChange.OpTime = DateTime.Now;
                    if (!Flw_MemberCard_ChangeService.I.Update(cardChange))
                    {
                        return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, string.Format("写入{0}记录失败", operate));
                    }
        ...
        public object renewCard(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    ...
                    cardRenew.CardID = memberCard.ID;
                    ...
                    if (!Flw_Food_SaleService.I.Update(sale))
                    {
                        return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "续卡失败");
                    }
        ...
        [Authorize(Roles = "StoreUser")]
        [ApiMethodAttribute(SignKeyEnum = SignKeyEnum.XCCloudUserCacheToken, SysIdAndVersionNo = false)]
        public object bindNewCard(Dictionary<string, object> dicParas)
        {
            try
            {
                string errMsg = string.Empty;
                ...
                Data_Member_Card virtualCard = Data_Member_CardService.I.GetModels(t => t.ID == order.CardID).FirstOrDefault();
                if (virtualCard == null)
                {
                    return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "会员卡不存在");
                }
                ...
                if (verifyCard != null)
                {
                    ...
                    if (verifyCardStore != null)
                    {
                        return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "当前读取的卡信息已存在，请使用空白卡进行操作");
                    }
                }
                ...
                if (schedule == null)
                {
                    return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "当前班次为空，不能进行换领卡操作");
                }
                decimal OpFree = order.PayCount.Value;
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    //虚拟卡卡号替换成新的实体卡卡号
                    virtualCard.ICCardID = newCardNo;
                    virtualCard.RepeatCode = iRepeatCode;
                    virtualCard.LastStore = storeId;
                    virtualCard.UpdateTime = DateTime.Now;
                    bool ret = Data_Member_CardService.I.Update(virtualCard);
                    if (!ret)
                    {
                        return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "更新卡信息失败");
                    }

                    Flw_MemberCard_Change cardChange = Flw_MemberCard_ChangeService.I.GetModels(t => t.ID == sale.FoodID).FirstOrDefault();
                    cardChange.NewCardID = virtualCard.ID;
                    cardChange.State = 1;
                    cardChange.OpTime = DateTime.Now;
                    cardChange.OpStoreID = storeId;
                    cardChange.WorkStation = workStation;
                    ...
                    if (!Flw_MemberCard_ChangeService.I.Update(cardChange))
                    {
                        return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "写入换卡记录失败");
                    }
        ...
        public object balanceExchange(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                //源余额类别的【赠送区】余额
                var querySourceBalanceFree = from a in Data_Card_Balance_FreeService.N.GetModels(t => t.BalanceIndex == sourceBalance.BalanceIndex && t.CardIndex == currCard.ID)
                                             join b in Data_Card_Balance_StoreListService.N.GetModels(t => t.StoreID == storeId) on a.ID equals b.CardBalanceID 
                                             select new
                                             {
                                                 Balance = a.Balance
                ...
                //获取目标余额【赠送区】余额
                var queryTargetBalanceFree = from a in Data_Card_Balance_FreeService.N.GetModels(t => t.BalanceIndex == targetBalance.BalanceIndex && t.CardIndex == currCard.ID)
                                             join b in Data_Card_Balance_StoreListService.N.GetModels(t => t.StoreID == storeId) on a.ID equals b.CardBalanceID
                                             select new
                                             {
                                                 Balance = a.Balance
                ...
                //备注
                string note = string.Format("{0}兑换{1}", MemberBusiness.GetBalanceTypeModel(sourceBalance.BalanceIndex.Value).TypeName, MemberBusiness.GetBalanceTypeModel(targetBalance.BalanceIndex.Value).TypeName);
                //更新余额
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    //源余额减少
                    ...
                    fmd.SourceType = 5;
                    fmd.SourceID = change.ID;
                    fmd.BalanceIndex = targetBalance.BalanceIndex;
                    fmd.ChangeValue = exchangeVal;
                    fmd.Balance = targetBalance.Balance;
                    fmd.FreeChangeValue = 0;
                    fmd.FreeBalance = targetBalanceFree == null ? 0 : targetBalanceFree.Balance.Todecimal(0);
                    fmd.BalanceTotal = fmd.Balance + fmd.FreeBalance;
                    fmd.Note = note;
                    fmd.UserID = userId;
                    fmd.DeviceID = 0;
                    ...
                    mic.MerchID = merchID;
                    mic.StoreID = storeId;
                    mic.MemberID = currCard.MemberID;
                    mic.CardID = currCard.ID;
                    mic.ModifyFied = note;
                    mic.OldContext = (sourceBalance.Balance + iExchangeQty).ToString();
                    mic.NewContext = sourceBalance.Balance.ToString();
                    mic.ModifyTime = DateTime.Now;
                    mic.WorkStation = workStation;
                    mic.UserID = userId;
                    mic.CheckDate = schedule.CheckDate;
                    ...
                    mic.CardID = currCard.ID;
                    mic.ModifyFied = note;
                    mic.OldContext = (targetBalance.Balance - exchangeVal).ToString();
                    mic.NewContext = targetBalance.Balance.ToString();
                    mic.ModifyTime = DateTime.Now;
                    mic.WorkStation = workStation;
                    mic.UserID = userId;
                    mic.CheckDate = schedule.CheckDate;
        ...
        public object repairCoin(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                string balanceName = storeBalanceTypes.FirstOrDefault().TypeName;
            ...
            try
            {
                ...
                if (operateType == "1" || operateType == "3")
                {
                    ...
                    var targetBalanceIds = from a in Data_Card_BalanceService.N.GetModels(t => t.CardIndex == parentCard.ID && t.MerchID == merchID && t.BalanceIndex == balanceIndex)
                                           join b in Data_Card_Balance_StoreListService.N.GetModels(t => t.StoreID == storeId) on a.ID equals b.CardBalanceID
                                           join c in Dict_BalanceTypeService.N.GetModels(t => t.MerchID == merchID) on a.BalanceIndex equals c.ID
                                           select new
                                           {
                                               BalanceId = a.ID,
                                               BalanceName = c.TypeName
        ...
        public object getMemberFreeCoinInfoList(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                List<MemberFreeModel> list = GetFreeCoinList(merchID, storeId, member, memberCard, level, schedule, deviceBalanceIndex);
        ...
        #region 获取可赠币集合方法
        private List<MemberFreeModel> GetFreeCoinList(string merchID, string storeId, Base_MemberInfo member, Data_Member_Card memberCard, Data_MemberLevel level, Flw_Schedule schedule, int? deviceBalanceIndex)
        {
            //当前商户余额类别
            ...
            //当前用户所有可赠币规则
            var memberFreeQuery = Flw_MemberLevelFreeService.I.GetModels(t => t.MerchID == merchID && t.StoreID == storeId && t.MemberID == member.ID && t.CardIndex == memberCard.ID && t.EndDate >= now)
                                  .Select(t => new
                                  {
                                      Id = t.ID,
                                      FreeID = t.FreeID,
            ...
            {
                //取最后一条生日赠币记录
                Flw_MemberCard_Free birthdayFree = Flw_MemberCard_FreeService.I.GetModels(t => t.MerchID == merchID && t.StoreID == storeId && t.MemberID == member.ID && t.CardIndex == memberCard.ID && t.FreeType == 2)
            ...
            {
                //取最后输赢赠币记录
                Flw_MemberCard_Free winOrLoseFree = Flw_MemberCard_FreeService.I.GetModels(t => t.MerchID == merchID && t.StoreID == storeId && t.MemberID == member.ID && t.CardIndex == memberCard.ID && t.FreeType == 3)
                                                    .OrderByDescending(t => t.CheckDate).FirstOrDefault();
        ...
        public object getBalanceChangeList(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                var deviceGameList = queryDeviceGameList.ToList();
        ...
        [Authorize(Roles = "StoreUser")]
        [ApiMethodAttribute(SignKeyEnum = SignKeyEnum.XCCloudUserCacheToken, SysIdAndVersionNo = false)]
        public object memberTransfer(Dictionary<string, object> dicParas)
        {
            try
            {
                string errMsg = string.Empty;
                string fromICCardId = dicParas.ContainsKey("fromICCardId") ? dicParas["fromICCardId"].ToString() : string.Empty;
                string toICCardId = dicParas.ContainsKey("toICCardId") ? dicParas["toICCardId"].ToString() : string.Empty;
                string pwd = dicParas.ContainsKey("pwd") ? dicParas["pwd"].ToString() : string.Empty;

                if (string.IsNullOrEmpty(fromICCardId))
                {
                    return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "转出卡号为空");
                }
                if (string.IsNullOrEmpty(toICCardId))
                {
                ...
                //判断会员卡是否存在或是否存在多张相同卡号的会员卡
                if (!MemberBusiness.ExistsCardByICCardId(fromICCardId, merchID, storeId, out errMsg))
                {
                    return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, errMsg);
                }
                //转出会员卡
                Data_Member_Card fromCard = Data_Member_CardService.I.GetModels(t => t.MerchID == merchID && t.ICCardID == fromICCardId).FirstOrDefault();
                //判断是否为附属卡
                ...
                if (!MemberBusiness.ExistsCardByICCardId(toICCardId, merchID, storeId, out errMsg))
                {
                    return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, errMsg);
                }
                //当前会员卡
                Data_Member_Card toCard = Data_Member_CardService.I.GetModels(t => t.MerchID == merchID && t.ICCardID == toICCardId).FirstOrDefault();
                //判断是否为附属卡
                ...
                var fromBalanceQuery = from a in Data_Card_BalanceService.N.GetModels(t => t.CardIndex == fromCard.ID && t.MerchID == merchID)
                                       join b in Data_Card_Balance_StoreListService.N.GetModels(t => t.StoreID == storeId) on a.ID equals b.CardBalanceID
                                       join c in Dict_BalanceTypeService.N.GetModels(t=>t.MerchID == merchID && t.State == 1 && t.MappingType == 1)  on a.BalanceIndex equals c.ID
                                       select new
                                       {
                                           BalanceId = a.ID,
                                           BalanceIndex = a.BalanceIndex
                ...
                var fromBalanceList = fromBalanceQuery.ToList();
                ...
                var toBalanceList = toBalanceQuery.ToList();

                //【赠送】转出卡在当前门店的余额ID集合
                var fromBalanceFreeQuery = from a in Data_Card_Balance_FreeService.N.GetModels(t => t.CardIndex == fromCard.ID && t.MerchID == merchID)
                                           join b in Data_Card_Balance_StoreListService.N.GetModels(t => t.StoreID == storeId) on a.ID equals b.CardBalanceID
                                           join c in Dict_BalanceTypeService.N.GetModels(t => t.MerchID == merchID && t.State == 1 && t.MappingType == 1) on a.BalanceIndex equals c.ID
                                           select new
                                           {
                ...
                var fromBalanceFreeList = fromBalanceFreeQuery.ToList();

                //【赠送】转入卡在当前门店的余额ID集合
                var toBalanceFreeQuery = from a in Data_Card_Balance_FreeService.N.GetModels(t => t.CardIndex == toCard.ID && t.MerchID == merchID)
                                         join b in Data_Card_Balance_StoreListService.N.GetModels(t => t.StoreID == storeId) on a.ID equals b.CardBalanceID
                                         select new
                                         {
                                             BalanceId = a.ID,
                ...
                var toBalanceFreeList = toBalanceFreeQuery.ToList();

                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    foreach (var item in fromBalanceList)
                    {
                        //正价变更值、赠送变更值
                        decimal changeValue = 0;
                        decimal freeChangeValue = 0;

                        //转出余额
                        Data_Card_Balance fromBalance = Data_Card_BalanceService.I.GetModels(t => t.ID == item.BalanceId).FirstOrDefault();

                        //转入卡对应类别的余额
                        var tb = toBalanceList.FirstOrDefault(t => t.BalanceIndex == item.BalanceIndex);
                        if(tb == null)
                        {
                            continue;
                        }
                        ...
                        Data_Card_Balance_Free fromBalanceFree = null;
                        Data_Card_Balance_Free toBalanceFree = null;
                        //赠送余额处理
                        var fromModle = fromBalanceFreeList.FirstOrDefault(t => t.BalanceIndex == item.BalanceIndex);
                        if (fromModle == null)
                        {
                            fromBalanceFree = new Data_Card_Balance_Free();
                            fromBalanceFree.Balance = 0;
                        }
                        else
                        {
                            fromBalanceFree = Data_Card_Balance_FreeService.I.GetModels(t => t.ID == fromModle.BalanceId).FirstOrDefault();
                        }

                        var toModle = toBalanceFreeList.FirstOrDefault(t => t.BalanceIndex == item.BalanceIndex);
                        if (toModle == null)
                        {
                            toBalanceFree = new Data_Card_Balance_Free();
                            toBalanceFree.Balance = 0;
                        }
                        else
                        {
                            fromBalanceFree = Data_Card_Balance_FreeService.I.GetModels(t => t.ID == toModle.BalanceId).FirstOrDefault();
                        }

                        //赠送余额转入
                        toBalanceFree.Balance += fromBalanceFree.Balance;
                        if (!Data_Card_Balance_FreeService.I.Update(toBalanceFree))
                        {
                            return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "更新转入卡余额失败");
                        }
                        freeChangeValue = fromBalanceFree.Balance.Todecimal(0);
                        //转出卡清零
                        fromBalanceFree.Balance = 0;
                        if (!Data_Card_Balance_FreeService.I.Update(fromBalanceFree))
                        {
                            return ResponseModelFactory.CreateModel(isSignKeyReturn, Return_Code.T, "", Result_Code.F, "更新转出卡余额失败");
                        }
                        ...
                        transfer.TransferBalanceIndex = item.BalanceIndex;
                        transfer.TransferCount = changeValue + freeChangeValue;
                        transfer.BalanceOut = fromBalance.Balance + fromBalanceFree.Balance;
                        transfer.BalanceIn = toBalance.Balance + toBalanceFree.Balance;
                        ...
                        //fmd.MemberLevelName = levelModel.MemberLevelName;
                        fmd.MemberLevelName = XCCloudStoreBusiness.GetMemberLevel(fromCard.MemberLevelID.Value).MemberLevelName;
                        fmd.ChannelType = (int)MemberDataChannelType.吧台;
                        ...
                        fmd.FreeChangeValue = 0 - freeChangeValue;
                        fmd.FreeBalance = fromBalanceFree.Balance;
                        fmd.BalanceTotal = fmd.Balance + fmd.FreeBalance;
                        fmd.Note = "过户转出";
                        fmd.UserID = userId;
                        fmd.DeviceID = 0;
                        ...
                        fmd.MemberLevelName = XCCloudStoreBusiness.GetMemberLevel(toCard.MemberLevelID.Value).MemberLevelName;
                        fmd.ChannelType = (int)MemberDataChannelType.吧台;
                        ...
                        fmd.FreeChangeValue = freeChangeValue;
                        fmd.FreeBalance = toBalanceFree.Balance;
                        fmd.BalanceTotal = fmd.Balance + fmd.FreeBalance;
                        fmd.Note = "过户转入";
                        fmd.UserID = userId;
                        fmd.DeviceID = 0;
            ...
            try
            {
                ...
                using (TransactionScope ts = new TransactionScope(TransactionScopeOption.RequiresNew))
                {
                    ...
                    foreach (var item in balanceFreeList)
                    {
                        ...
                        if (!Data_Card_Balance_FreeService.I.Update(freeBalance))
                        {
                    ...
                    if (!Data_Member_CardService.I.Update(memberCard))
                    {
        ...
        [Authorize(Roles = "StoreUser")]
        [ApiMethodAttribute(SignKeyEnum = SignKeyEnum.XCCloudUserCacheToken, SysIdAndVersionNo = false)]
        public object getTicketInfoList(Dictionary<string, object> dicParas)
        {
            try
            {
                string errMsg = string.Empty;
                ...
                var queryTicket = from a in Flw_Project_TicketInfoService.I.GetModels(t => t.MerchID == merchID && t.CardID == memberCard.ID)
                                          join b in Flw_ProjectTicket_BindService.I.GetModels(t => t.MerchID == merchID) on a.Barcode equals b.ProjectCode
                                  join c in Flw_ProjectTicket_EntryService.I.GetModels(t => t.MerchID == merchID) on a.Barcode equals c.ProjectCode
                                          select new
                                          {
                                              TicketId = a.ID,
                ...
                var ticketList = queryTicket.ToList().Select(t => new
                {
                    TicketId = t.TicketId,
                    TicketName = t.TicketName,
                    TicketType = t.TicketType.HasValue ? ((TicketType)t.TicketType).ToDescription() : "",
                    SaleTime = t.SaleTime.HasValue ? t.SaleTime.Value.ToString("yyyy-MM-dd HH:mm:ss") : "",
                    EndDate = t.EndDate.HasValue ? t.EndDate.Value.ToString("yyyy-MM-dd HH:mm:ss") : "",
                    WriteOffDays = t.WriteOffDays.HasValue ? t.WriteOffDays + "天" : "",
                    BuyCount = t.BuyCount,
                    RemainCount = t.RemainCount,
                    State = t.State.HasValue ? ((TicketState)t.State).ToDescription() : "",
                    Note = getTicketNote(t.WeekType, t.Week, t.StartTime, t.EndTime)
                }).ToList();
        ...
        string getTicketNote(int? weekType, string weeks, TimeSpan? sTime, TimeSpan? eTime)
        {
        ...
        [Authorize(Roles = "StoreUser")]
        [ApiMethodAttribute(SignKeyEnum = SignKeyEnum.XCCloudUserCacheToken, SysIdAndVersionNo = false)]
        public object getOrderState(Dictionary<string, object> dicParas)
        {
            try
            {
                string errMsg = string.Empty;
                ...
                {
                    OrderId = order.ID,
                    Amount = order.PayCount.ToString(),
        ...
        public object getBalanceaaaaa(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                var query = from c in Base_DeviceInfoService.I.GetModels(t => t.MerchID == merchId && t.StoreID == storeId)
                            join d in Data_GameInfoService.I.GetModels(t => t.MerchID == merchId && t.StoreID == storeId) on c.GameIndexID equals d.ID into d1
                            from d in d1.DefaultIfEmpty()
                            select new
                            {
