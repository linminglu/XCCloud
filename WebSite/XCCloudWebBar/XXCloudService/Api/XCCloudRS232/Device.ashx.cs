...
using XCCloudWebBar.Model.CustomModel.XCCloudRS232;
...
namespace XXCloudService.Api.XCCloudRS232
{
    public class Device : ApiBase
    {
        ...
        public object register(Dictionary<string, object> dicParas)
        {
            ...
            XCCloudWebBar.BLL.IBLL.XCCloudRS232.IDeviceService xcCloudRS232DeviceService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCCloudRS232.IDeviceService>();
