    ...
    public class Ticket : ApiBase
    {
        ...
        public object getTicketInfo(Dictionary<string, object> dicParas)
        {
            try
            {
                ...
                {
                    //验证门票是否有效
                    XCCloudWebBar.BLL.IBLL.XCGame.IProject_buy_codelistService codeListService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IProject_buy_codelistService>(storeModel.StoreDBName);
                    ...
                    //验证门票项目是否有效
                    XCCloudWebBar.BLL.IBLL.XCGame.IProjectService projectService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IProjectService>(storeModel.StoreDBName);
                    ...
                    //验证购买记录
                    XCCloudWebBar.BLL.IBLL.XCGame.IProject_buyService projectBuyService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IProject_buyService>(storeModel.StoreDBName);
                    ...
                    if (Convert.ToInt32(codeListModel.ProjectType) == 0)
                    {
                        ...
                        using (TransactionScope ts = new TransactionScope())
                        {
                            try
                            {
                                ...
                                XCCloudWebBar.BLL.IBLL.XCGame.IProjectPlayService projectPlayService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IProjectPlayService>(storeModel.StoreDBName);
        ...
        public object exchangeOutTicket(Dictionary<string, object> dicParas)
        {
            ...
            if (storeModel.StoreDBDeployType == 0)
            {
                XCCloudWebBar.BLL.IBLL.XCGame.IFlwTicketExitService flwTicketExitService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IFlwTicketExitService>(storeModel.StoreDBName);
                XCCloudWebBar.BLL.IBLL.XCGame.IMemberService memberService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IMemberService>(storeModel.StoreDBName);
                XCCloudWebBar.BLL.IBLL.XCGame.IScheduleService scheduleService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IScheduleService>(storeModel.StoreDBName);
                XCCloudWebBar.BLL.IBLL.XCGame.IParametersService parametersService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IParametersService>(storeModel.StoreDBName);
        ...
        public object getOutTicket(Dictionary<string, object> dicParas)
        {
            ...
            if (storeModel.StoreDBDeployType == 0)
            {
                ...
                XCCloudWebBar.BLL.IBLL.XCGame.IHeadService headService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IHeadService>(storeModel.StoreDBName);
                ...
                XCCloudWebBar.BLL.IBLL.XCGame.IGameService gameService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IGameService>(storeModel.StoreDBName);
