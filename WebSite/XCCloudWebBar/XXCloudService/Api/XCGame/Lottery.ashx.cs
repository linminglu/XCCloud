...
namespace XXCloudService.Api.XCGame
{
    ...
    public class Lottery : ApiBase
    {
        ...
        public object getLotteryInfo(Dictionary<string, object> dicParas)
        {
            ...
            { 
                XCCloudWebBar.BLL.IBLL.XCGame.IFlwLotteryService lotteryService = BLLContainer.Resolve<XCCloudWebBar.BLL.IBLL.XCGame.IFlwLotteryService>(storeModel.StoreDBName);
