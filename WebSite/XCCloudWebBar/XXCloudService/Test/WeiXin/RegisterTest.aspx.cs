...
namespace XXCloudService.Test.WeiXin
{
    public partial class RegisterTest : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {                
                ...
                int userType = -1;
                string openId = Request["openId"] != null ? Request["openId"].ToString() : string.Empty;
                string unionId = Request["unionId"] != null ? Request["unionId"].ToString() : string.Empty;
