...
namespace XCCloudWebBar.Base
{
    ...
    public class ResponseModel
    {
        ...
        public ResponseModel(string return_code, string return_msg, string result_code, string result_msg, int result_type = (int)XCCloudWebBar.Base.Result_Type.Tips)
        {
            this.Return_Code = return_code;
            this.Return_Msg = return_msg;
    ...
    public class NoSignKeyResponseModel
    {
        ...
        public NoSignKeyResponseModel(string return_code, string return_msg, string result_code, string result_msg, int result_type = (int)XCCloudWebBar.Base.Result_Type.Tips)
        {
            this.Return_Code = return_code;
            this.Return_Msg = return_msg;
            this.Result_Code = result_code;
