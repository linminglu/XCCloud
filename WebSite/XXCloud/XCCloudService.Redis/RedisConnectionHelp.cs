...
namespace XCCloudService.Redis
{
    /// <summary>
    ...
    public static class RedisConnectionHelp
    {
        ...
        private static void MuxerConfigurationChangedBroadcast(object sender, EndPointEventArgs e)
        {
            ...
            Console.WriteLine(string.Format("重新配置广播时 name: {1}", e.EndPoint));
        }
        ...
        {
            Console.WriteLine("changed: " + e.EndPoint);
        }
        ...
        {
            Console.WriteLine("发生内部错误时: " + e.Message);
        }
        ...
        {
            Console.WriteLine("重新建立连接之前的错误: " + e.EndPoint);
        }
