...
{
    public partial class WebKitBrowserUC : UserControl
    {
        ...
        private void InitializeWebKit()
        {
            ...
            this.ShowJavaScriptConfirmPanel += (s, e) =>
            {
                e.ReturnValue = System.Windows.Forms.MessageBox.Show(e.Message, "[JavaScript Confirm]", System.Windows.Forms.MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.Yes;
            };
        ...
        private void uiDelegate_CreateWebViewWithRequest(IWebURLRequest request, out WebView webView)
        {
            ...
            if (!args.Cancel)
            {
                WebKitBrowserUC b = new WebKitBrowserUC();
                webView = (WebView)b.webView;
                NewWindowCreated(this, new NewWindowCreatedEventArgs(b));
                ShowJavaScriptConfirmPanel(this, new ShowJavaScriptConfirmPanelEventArgs(""));
            }
            else
            {
                webView = null;
        ...
        #region WebUIJavaScriptDelegate event handlers
