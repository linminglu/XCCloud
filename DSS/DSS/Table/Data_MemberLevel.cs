...
public int? ContinueUseBalanceIndex { get; set; }
public decimal? ContinueUseCount { get; set; }
public decimal? ConsumeTotle { get; set; }
public int? UpdateUseBalanceIndex { get; set; }
public decimal? UpdateUseCount { get; set; }
